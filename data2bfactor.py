...
def data2b_atom(mol='', data_file='', property='b', quiet=1):
    """
DESCRIPTION
...
SEE ALSO
    ...
    #select atoms that make hydrogen bonds and that you want to be colored by b factor
    for chain_letter in b_dict.keys():
        #print(chain_letter)
        chain_dict = b_dict[chain_letter]
        for res_num in chain_dict.keys():
            #print(res_num)
            cmd.select("lig_color", "resi %s and chain %s" %(res_num, chain_letter), merge=1)

def data2b_res(mol='', data_file='', property='b', quiet=1):
    """
DESCRIPTION
...
SEE ALSO
    ...
    for chain_letter in b_dict.keys():
        ...
        for res_num in chain_dict.keys():
            #print(res_num)
            cmd.select("res_to_color", "resi %s and chain %s" %(res_num, chain_letter), merge=1)
